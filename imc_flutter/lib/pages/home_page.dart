...
class _HomePageState extends State<HomePage> {
  ...
  String imcCategory({required double imcResult}) {
    if (imcResult < 1) {
      return '';
    } else if (imcResult >= 1.0 && imcResult <= 18.5) {
      return 'Baixo peso';
        ...
        child: ListView(
          children: const [
            UserAccountsDrawerHeader(
              ...
              accountName: Text('Débora Sousa'), 
              accountEmail: Text('deborasilva.sousa38@gmail.com'),
              ),
              ListTile(
                leading: Icon(Icons.home),
                title: Text('Pagina Inicial'),
                subtitle: Text('Vai para o início'),
                trailing: Icon(Icons.arrow_forward_ios_sharp),
              ),
              ListTile(
                leading: Icon(Icons.calculate),
                title: Text('Calcular IMC'),
                subtitle: Text('Vai para a tela de calcular IMC'),
                trailing: Icon(Icons.arrow_forward_ios_sharp),
              )
          ],
        ),
